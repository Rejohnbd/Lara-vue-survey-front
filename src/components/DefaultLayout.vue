              ...
              <Menu as="div" class="ml-3 relative">
                ...
                <transition enter-active-class="transition ease-out duration-100"
                  ...
                  <MenuItems
                    ...
                    <a @click="logout" :class="['block px-4 py-2 text-sm text-gray-700 corsor-pointer']">Sign out</a>
                    </MenuItem>
                  </MenuItems>
                </transition>
              </Menu>
        ...
        <div class="pt-4 pb-3 border-t border-gray-700">
          ...
          <div class="mt-3 px-2 space-y-1">
            <DisclosureButton @click="logout"
              class="block px-3 py-2 rounded-md text-base font-medium text-gray-400 hover:text-white hover:bg-gray-700 corsor-pointer">
              Sign out
            </DisclosureButton>
          </div>
        </div>
